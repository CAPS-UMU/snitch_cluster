...
echo -e "\tmany_gemms.sh: gemm dir is $gemmDir" # we require this variable to be set as an env var ahead of time.
echo -e "\tmany_gemms.sh: experiment dir is $experimentDir" # we require this variable to be set as an env var ahead of time.
            ...
            then
                ...
                if [[ $(ls "$logs/$buildName.csv" &> /dev/null; echo $?) != "0" ]];
                        then
                            ...
                            if [[ $(python verify.py "$buildDir/verify-output.txt"; echo $?) != "0" ]];
                            then
                                echo -e "\t\t$buildName...... OK"
                            else
