...
static inline void gemm_fp64_naive_myrtle(uint32_t setup_ssr, uint32_t partition_banks,
...
static inline void gemm_fp64_opt_myrtle(uint32_t setup_ssr, uint32_t partition_banks,
                                 uint32_t transa, uint32_t transb, uint32_t M,
                                 uint32_t N, uint32_t K, void* A_p,
                                 uint32_t lda, void* B_p, uint32_t ldb,
                                 uint32_t beta, void* C_p, uint32_t ldc) {
